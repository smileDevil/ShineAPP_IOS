...
class RecommendCycieView: UIView {
    //MARK: 定义展示属性d
    //定时器
...
extension RecommendCycieView {
    class func recommendCycleViewe() -> RecommendCycieView {
        return  Bundle.main.loadNibNamed("RecommendCycieView", owner: nil, options: nil)?.first as! RecommendCycieView
    }
}

//MARK: 遵守collectionView的数据源协议

extension RecommendCycieView : UICollectionViewDataSource{
...
extension RecommendCycieView : UICollectionViewDelegate{
